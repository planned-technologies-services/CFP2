...
namespace MyCompany.Security
{
    ...
    public class EventTrackerBase
    {
        ...
        private static Regex _modifiedByUserNameRegex = new Regex("ModifiedBy|updated_by|updated_by", RegexOptions.IgnoreCase);
        
        private static Regex _modifiedByUserIdRegex = new Regex("ModifiedByUserId|userid", RegexOptions.IgnoreCase);
        
        private static Regex _modifiedOnRegex = new Regex("ModifiedOn|updated|updated_date", RegexOptions.IgnoreCase);
        
        private static Regex _createdByUserNameRegex = new Regex("CreatedBy|created_by", RegexOptions.IgnoreCase);
        
        private static Regex _createdByUserIdRegex = new Regex("CreatedById|created_user_id|userid", RegexOptions.IgnoreCase);
        
        private static Regex _createdOnRegex = new Regex("CreatedOn|create_date|created_date", RegexOptions.IgnoreCase);
